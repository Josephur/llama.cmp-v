...
![Complete fork versus stock: prompt processing and generation throughput](cmp/docs/assets/current-stock.svg)
...
[Benchmark details](cmp/docs/results/benchmarks.md) · [Machine-readable measurements](cmp/docs/results/data/current-stock.json)
