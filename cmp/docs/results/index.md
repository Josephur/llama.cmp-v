...
![Complete fork versus stock: prompt processing and generation throughput](../assets/current-stock.svg)
...
[Benchmark details](benchmarks.md) · [Machine-readable measurements](../results/data/current-stock.json)
