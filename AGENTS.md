...
## Generated CMP release tree

This is generated release output. Do not develop optimizations or store private configuration, agent tooling, raw model responses or deployment scripts here. Source changes belong in the maintainer's working repository and reach this tree through a reviewed export. Public source patches prove reconstruction only; consult the accompanying results before claiming a measured gain. Do not treat the presence of binaries or patches as hardware validation.
